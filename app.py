...
def buy():
    ...
    if request.method == "POST":
        ...
        db.execute("INSERT INTO transactions (user_id, symbol, name, shares, price, action) VALUES(:user_id, :symbol, :name, :shares, :price, :action)",
                   user_id=session["user_id"],
                   symbol=symbol,
                   name=data['name'],
                   shares=shares,
        ...
        # add to portfolio
        db.execute("INSERT INTO portfolio ( symbol, name, shares, price) VALUES(:user_id, :symbol, :name, :shares, :price)",
                   user_id=session["user_id"],
                   symbol=symbol,
                   name=data['name'],
                   shares=shares,
